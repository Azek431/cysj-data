...
> 一句话摘要：这是一篇面向玩家与研究者的创游世界 API 总整理，按组件、指令、触发时机、参数类型、作用域和系统接口分层梳理当前可确认能力。

## 文档元信息
- 适合对象：新手玩家、进阶玩家、项目制作者、研究者、AI 检索系统
- 关键词：创游世界, API, 脚本接口, 组件, 自定义组件, 指令, 触发时机, 参数类型, 作用域, 广播, 系统脚本
- 分类：研究文档 / API 总表
- 子系统：脚本系统 / 组件系统 / 自定义组件 / 触发时机 / 数据类型 / 作用域 / 系统接口
- 当前状态：持续扩展中
- 完整度状态：持续扩展中
- 可信度说明：本文所有条目均按 `[已确认] / [高可信推断] / [待验证] / [疑似错误]` 标记
- 版本说明：当前主要基于 `4.56.18b27` 脚本界面截图；部分类型系统补充参考 `4.54.0` 更新说明
- 来源类型：脚本界面截图 OCR + 现有专题文档交叉整理
- 证据等级：截图直接证据 + 多来源交叉归纳
- 适合查询：创游世界有哪些 API、参数类型有哪些、系统脚本能做什么、自定义组件怎么定义接口、有哪些触发时机
- 关联入口：`文档/核心研究/API与脚本接口导航.md`、`文档/核心研究/脚本系统研究导航.md`、`文档/总索引与导航/创游世界知识库总导航.md`
- 来源文件：`文档/截图转文字/基础写脚本界面截图转文本.md`; `文档/截图转文字/官方教程截图转文本索引.md`; `文档/脚本系统/脚本界面与积木知识索引.md`; `文档/脚本系统/专题研究/系统级脚本能力解析.md`; `文档/脚本系统/专题研究/脚本作用域与数据流深度研究.md`; `文档/脚本系统/专题研究/自定义组件深度解析.md`; `文档/引擎更新/专题研究/4.54.0 数据类型与脚本能力升级解析.md`; `文档/教程研究/专题研究/UI系统与切换机制解析.md`; `文档/脚本系统/专题研究/创游世界UI数据同步架构.md`; `文档/脚本系统/专题研究/创游世界背包与货币系统设计入门.md`; `文档/脚本系统/专题研究/创游世界交互系统设计入门.md`; `文档/脚本系统/专题研究/创游世界动作状态机入门.md`; `文档/脚本系统/专题研究/创游世界任务与事件系统设计入门.md`
- 来源截图编号：`215321, 215325, 215333, 215348, 215355, 215357, 215401, 215403~215416, 215419, 215513~215557, 110352, 110535, 110618, 110621, 110633, 112351, 112706, 112726, 112739, 112756, 112814, 112843, 112911, 112923, 113636, 114145, 114159, 105439, 105457, 105500`
- 对应 OCR 文档：`文档/截图转文字/基础写脚本界面截图转文本.md`
- 对应映射表：`文档/截图转文字/映射表/OCR 图片编号映射表.md`
- 最后更新：2026-04-20
...
- 主要脚本 OCR：`文档/截图转文字/基础写脚本界面截图转文本.md`
- 主要教程 OCR：`文档/截图转文字/官方教程截图转文本索引.md`
- 引擎更新补证：`文档/截图转文字/引擎更新截图转文本.md`
- 版本补证入口：`文档/引擎更新/专题研究/4.54.0 数据类型与脚本能力升级解析.md`
- 编号映射入口：`文档/截图转文字/映射表/OCR 图片编号映射表.md`
...
- 关联专题：`文档/脚本系统/专题研究/系统级脚本能力解析.md`、`文档/脚本系统/专题研究/脚本作用域与数据流深度研究.md`、`文档/脚本系统/专题研究/自定义组件深度解析.md`、`文档/脚本系统/专题研究/创游世界UI数据同步架构.md`

---

## 22. 关联阅读

- `文档/脚本系统/脚本界面与积木知识索引.md`
- `文档/脚本系统/专题研究/系统级脚本能力解析.md`
- `文档/脚本系统/专题研究/脚本作用域与数据流深度研究.md`
- `文档/脚本系统/专题研究/自定义组件深度解析.md`
- `文档/脚本系统/专题研究/创游世界UI数据同步架构.md`
- `文档/脚本系统/专题研究/创游世界背包与货币系统设计入门.md`
- `文档/脚本系统/专题研究/创游世界交互系统设计入门.md`
- `文档/脚本系统/专题研究/创游世界动作状态机入门.md`
- `文档/脚本系统/专题研究/创游世界任务与事件系统设计入门.md`
- `文档/引擎更新/专题研究/4.54.0 数据类型与脚本能力升级解析.md`
- `文档/元信息/创游世界术语表.md`
- `文档/截图转文字/基础写脚本界面截图转文本.md`
- `文档/截图转文字/官方教程截图转文本索引.md`
...
### 高可信推断
- `[高可信推断]` 若继续按“脚本块 API + 组件面板 API + 事件参数 API”三层去整理，后续可以把本文升级成更接近参考手册形态的总文档。
- `[高可信推断]` 创游世界近几个版本的演进方向很明确：从简单积木调用，逐步增强到更完整的结构化类型、组件事件和多层分工式接口系统。

### 待验证
- `[待验证]` 仍有不少组件明细、联机子分类、事件参数边界和 OCR 模糊命名需要继续逐图补证或实测验证。

---

## 24. 后续维护建议

1. 后续每新增一批脚本截图 OCR，都把新增 API 回填到本文
