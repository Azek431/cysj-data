...
#### 当前主要缺口
- 文档头部虽然说明目录里有 200+ 张图片，但当前并没有逐图完成
...
2. 优先补粒子特效与显示类剩余页
3. 优先补地图 / UI / 数据关系页
4. 给更多截图增加状态标签：已入档 / 无有效文本 / 疑似重复页 / 待复核 / 待处理
...
- 其中：
  - `OCR 状态词与回链规范.md` 负责统一状态词与三段式回链规则
  - `OCR 完整化总表.md` 负责给出三大目录的总量、现状、优先级与执行要求
  - `OCR 资料总览与完整化现状.md` 负责解释“现在做到哪、离完整还差哪”
  - `OCR 未识别与残缺清单.md` 负责记录仍需回扫和清洗的问题页
